...
import 'package:timetracker/Screens/POC/AnimatedDrawer/AnimatedDrawer.dart';
import 'package:timetracker/Screens/POC/AnimatedDrawer/Drawer.dart';
  ...
  Widget build(BuildContext context) {
    return MultiProvider(
      providers: [
        ...
        ChangeNotifierProvider(create: (_) => LimitAppUsageController()),
      ],
